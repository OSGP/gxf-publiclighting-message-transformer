...
class CucumberSpringConfiguration {
    ...
    @ParameterType(
        "GET_CONFIGURATION_REQUEST|GET_FIRMWARE_VERSION_REQUEST|GET_LIGHT_STATUS_REQUEST|GET_STATUS_REQUEST|" +
            ...
            "SET_LIGHT_REQUEST|SET_SCHEDULE_REQUEST|SET_TRANSITION_REQUEST|START_SELF_TEST_REQUEST|STOP_SELF_TEST_REQUEST",
    )
    ...
    @ParameterType(
        "GET_CONFIGURATION|GET_FIRMWARE_VERSION|GET_LIGHT_STATUS|GET_STATUS|RESUME_SCHEDULE|" +
            "SET_CONFIGURATION|SET_EVENT_NOTIFICATIONS|SET_LIGHT|SET_REBOOT|SET_SCHEDULE|" +
